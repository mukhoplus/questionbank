...
excel_path = f'.\하위권도우미_사업_기출문제_및_정답_{input_title}.xlsx'  # 엑셀 파일 경로
sheet_name = '문제은행' # 시트 이름
is_mid = True if exam_type == '중간' else False
...
save_documents(doc_question, doc_empty, doc_answer, input_title)
